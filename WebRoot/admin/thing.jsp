    ...
    <table cellpadding="0" cellspacing="0" id="maintable">
        <tr>
  		...
  		<table id="sqltable">
		                ...
		                <tr class="rows">
			                <td>${list.name}</td>
			                <td>${list.thingtype.type}</td>
			                <td>${list.thingtype2.type}</td>
			                <td>${list.price}元</td>
			                <td>${list.num}</td>
			                <td>
			                	<a href="<%=basePath %>pinglun/admin_list.do?jid=${list.id}">评论</a>
				                <a href="<%=basePath %>thing/editpage.do?id=${list.id}">更新</a>
