  ...
  <body>
    ...
    <table cellpadding="0" cellspacing="0" id="maintable">
        <tr>
            ...
            <td>
  	<button class="layui-btn layui-btn-normal" onclick="location.href='<%=basePath%>thingtype/addpage.do'">添加</button>
  		<table id="sqltable">
		                <tr class="title">
			               <td>分类</td>
			                <td>操作</td>
		                ...
		                <tr class="rows">
			                <td>${list.type}</td>
			                <td>
				                <a href="<%=basePath %>thingtype/editpage.do?id=${list.id}">更新</a>
    ...
    $(function(){ 
    	$(".del").click(function(){
		    ...
		    $.messager.confirm("系统提示", "您确认要删除这条数据吗？", function(r) {
				if (r) {
					$.post("${basePath}thingtype/del.do", {
						id:id
					}, function(result) {
						if (result.success) {
